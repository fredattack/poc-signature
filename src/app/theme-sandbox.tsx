  ...
  ({
    ...
    <View style={styles.swatchContainer}>
      ...
      <View style={styles.swatchMeta}>
        ...
        <Text style={[styles.metaValue, { color: secondaryColor }]}>{value}</Text>
      </View>
    </View>
  )
);
...
const TypographyPreview = memo(
  ({ label, styleKey }: { label: string; styleKey: keyof ReturnType<typeof useThemeTokens>['tokens']['typography'] }) => {
    const {
      tokens: { typography },
      colors,
    } = useThemeTokens();
...
export default function ThemeSandboxScreen() {
  ...
  return (
    <>
      <ScrollView style={[styles.container, componentBackground]} contentInsetAdjustmentBehavior="automatic">
      <Text style={[styles.heading, { color: colors.text.primary }]}>Palette principale</Text>
      ...
      <Text style={[styles.heading, { color: colors.text.primary }]}>Surface & textes</Text>
      <View style={styles.section}>
      ...
      <Text style={[styles.heading, { color: colors.text.primary }]}>Échelles typographiques</Text>
      <View style={styles.section}>
      ...
      <Text style={[styles.heading, { color: colors.text.primary }]}>Composants UI</Text>
      <View style={styles.section}>
        <View style={styles.componentGroup}>
          <Text style={[styles.componentLabel, { color: colors.text.secondary }]}>Boutons</Text>
        ...
        <View style={styles.componentGroup}>
          <Text style={[styles.componentLabel, { color: colors.text.secondary }]}>Input</Text>
          <Input
            label="Nom complet"
        ...
        <View style={styles.componentGroup}>
          <Text style={[styles.componentLabel, { color: colors.text.secondary }]}>Carte</Text>
          <Card>
            <Text style={{ color: colors.text.primary, marginBottom: tokens.spacing.xs }}>
        ...
        <View style={styles.componentGroup}>
          <Text style={[styles.componentLabel, { color: colors.text.secondary }]}>Toast</Text>
          <View style={styles.buttonRow}>
            <Button title="Succès" size="small" onPress={() => showToast('success')} />
            <Button title="Info" size="small" variant="secondary" onPress={() => showToast('info')} />
            <Button title="Erreur" size="small" variant="ghost" onPress={() => showToast('error')} />
          </View>
        </View>

        <View style={styles.componentGroup}>
          <Text style={[styles.componentLabel, { color: colors.text.secondary }]}>Modal</Text>
          <Button title="Ouvrir la modale" onPress={() => setModalVisible(true)} />
        </View>
      </View>
      </ScrollView>
      ...
      <Modal visible={modalVisible} onClose={() => setModalVisible(false)}>
        <Text style={{ color: colors.text.primary, marginBottom: tokens.spacing.sm }}>
          Cette modale utilise les tokens `overlay.medium`, `radii.generous` et `elevation.level3`.
        </Text>
